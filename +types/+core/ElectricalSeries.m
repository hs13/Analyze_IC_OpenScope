...
methods
    function obj = ElectricalSeries(varargin)
        ...
        % filtering = char
        varargin = [{'channel_conversion_axis' types.util.correctType(1, 'int32') 'data_conversion' types.util.correctType(1.0, 'float32') 'data_resolution' types.util.correctType(-1.0, 'float32') 'data_unit' 'volts'} varargin];
