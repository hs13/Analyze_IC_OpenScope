...
for ises = 1:Nsessions
    ...
    save(sprintf('%spostprocessed.mat', pathpp), 'vis', 'Tres', 'Rall', '-v7.3')
    
    save(sprintf('%svisresponses.mat', pathpp), ...
        'meanFRall', 'sponFRall', 'ICtrialtypes', 'ICsigall', 'RFCIall', 'RFCIspinall', ...
        'sizeCIall', 'oriparamsall', 'ori4paramsall', '-v7.3')
    
    if validfixgaze
        save(sprintf('%svisresponses_fixedgaze%dpix.mat', pathpp, gazedistthresh), ...
